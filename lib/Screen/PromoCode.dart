      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (!error) {
            ...
            if (mounted) {
              setSnackbar(getTranslated(context, 'PROMO_SUCCESS')!);
            }
          } else {
            isPromoValid = false;
            promoAmt = 0;
                                              ...
                                              Expanded(
                                                child: Text(
                                                  "${getTranslated(context,
                                                      "MIN_ORDER_VALUE")!} ${getPriceFormat(
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Expanded(
                                                child: Text(
                                                    "${getTranslated(context,
                                                        "OFFER_VALID_FROM")!} ${promoList[index]
                                                        .startDate} to ${promoList[index]
                                                        .endDate}",
                                                    style: const TextStyle(
                                                        fontSize:
                                                        12)),
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                child: promoList[index]
                                                    ...
                                                    ? Text(
                                                    "${getTranslated(context,
                                                        "MAX_APPLICABLE")!}  ${promoList[index]
                                                        .noOfRepeatUsage} times",
                                                    style: const TextStyle(
                                                        fontSize:
                                                        12))
                                                    : Text(
