          ...
          child: Padding(
              ...
              child: Selector<CartProvider, Tuple2<List<String?>, String?>>(
                builder: (context, data, child) {
                  if (data.item1.contains(productList[index].id)) {
                    _controller[index].text = data.item2.toString();
                  } else {
                    _controller[index].text =
                        model.prVarientList![model.selVarient!].cartCount!;
                  }
                  print("avaibility of ${model.name} ${model.availability}");
                  print("avaibility of ${model.name} ${model.total}");
    ...
    apiBaseHelper.postAPICall(getProductApi, parameter).then((getdata) {
      ...
      if (!error) {
        ...
        if ((offset) < total) {
          ...
          print("tempList len*****${tempList.length}");
